...
import com.example.mobileapp_.databinding.ActivityMapsBinding;
...
//        Log.d("xylication",lastLacation.getLatitude()+", "+lastLacation.getLongitude());
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(22.310470306212988, 114.22429238096183),DEFAULT_ZOOM));
//        mMap.getUiSettings().isZoomControlsEnabled();
//
//        LatLng sydney = new LatLng(22.310470306212988, 114.22429238096183);
